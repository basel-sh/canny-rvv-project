...
// ------------------------------------------------------------
// Measures per-stage execution time for the Canny pipeline
// (Gaussian, Sobel, Magnitude, Direction) and reports a
// percentage breakdown to identify which stages dominate
// runtime. This data justifies which kernels are worth
// hand-optimizing with RVV intrinsics in Phase 6.
//
// Per the hints guide, this uses clock_gettime(CLOCK_MONOTONIC)
// rather than gettimeofday(), since CLOCK_MONOTONIC cannot
// jump backward due to system clock adjustments.
// ============================================================
...
int main(int argc, char** argv) {
    // Usage: ./phase5_profiling [width] [height] [input_path] [iterations]
    ...
    printf("=== Phase 5: Profiling and Hotspot Identification ===\n");
    ...
    writeRaw("../Results/output_magnitude_phase5.raw", mag, WIDTH, HEIGHT);
    writeRaw("../Results/output_direction_phase5.raw", dir, WIDTH, HEIGHT);
